...
% Figure 4a,c - spectra for STIM v. PRE, POST v. PRE
...
% Figure 4b - topographies of STIM-PRE differences for specific freq bands
...
% Figure 4d - topographies of POST-PRE differences for specific freq bands
% using normalized power as in Fig 2b
comps = {'theta', 'sigma'};
all_lims = {[-6 6], [-4 4]};
for iComp = 1:numel(comps)
